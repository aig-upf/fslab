...
from fslab.experiment import FSExperiment
...
def get_repo_base():
    ...
    raise RuntimeError("repo base could not be found")


def is_running_on_cluster():
    return platform.node().startswith("node")
...
class FSIssueExperiment(FSExperiment):
